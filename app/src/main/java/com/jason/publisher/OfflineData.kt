...
object OfflineData {
    ...
    """.trimIndent()
        // bus start -> bus 15
        val jsonString2 = """
        [{"latitude":-36.78012,"longitude":174.99216},{"latitude":-36.79159,"longitude":174.99938},{"latitude":-36.78724,"longitude":175.00125},{"latitude":-36.78139,"longitude":175.007},{"latitude":-36.78338,"longitude":175.01086},{"latitude":-36.79883,"longitude":175.03447},{"latitude":-36.79589,"longitude":175.04737},{"latitude":-36.80141,"longitude":175.06579},{"latitude":-36.79887,"longitude":175.07527},{"latitude":-36.78842,"longitude":175.08309},{"latitude":-36.8011,"longitude":175.06984},{"latitude":-36.80149,"longitude":175.06619},{"latitude":-36.81456,"longitude":175.08249},{"latitude":-36.79601,"longitude":175.04829},{"latitude":-36.79689,"longitude":175.03242},{"latitude":-36.78365,"longitude":175.01139}]
    """.trimIndent()
        // bus start -> bus 4
        val jsonString3 = """
        [
            {"latitude":-36.854638,"longitude":174.764622}, 
            {"latitude":-36.853792,"longitude":174.765981}, 
            {"latitude":-36.854254,"longitude":174.767905}, 
            {"latitude":-36.855171,"longitude":174.767030}, 
            {"latitude":-36.856104,"longitude":174.765522}
        ]
    """.trimIndent()
        val jsonArray = JSONArray(jsonString2)
        for (i in 0 until jsonArray.length()) {
    ...
    fun getBusStopOfflineWithName(): List<BusStopInfo> {
        val jsonString = """
        [
            {"latitude":-36.78012,"longitude":174.99216,"busStopName":"S/E"}, // bus start
            {"latitude":-36.79159,"longitude":174.99938,"busStopName":"1"}, // bus 1
            {"latitude":-36.78724,"longitude":175.00125,"busStopName":"2"}, // bus 2
            {"latitude":-36.78139,"longitude":175.007,"busStopName":"3"},   // bus 3
            {"latitude":-36.78338,"longitude":175.01086,"busStopName":"4"}, // bus 4
            {"latitude":-36.79883,"longitude":175.03447,"busStopName":"5"}, // bus 5
            {"latitude":-36.79589,"longitude":175.04737,"busStopName":"6"}, // bus 6
            {"latitude":-36.80141,"longitude":175.06579,"busStopName":"7"}, // bus 7
            {"latitude":-36.79887,"longitude":175.07527,"busStopName":"8"}, // bus 8
            {"latitude":-36.78842,"longitude":175.08309,"busStopName":"9"}, // bus 9
            {"latitude":-36.8011,"longitude":175.06984,"busStopName":"10"},  // bus 10
            {"latitude":-36.80149,"longitude":175.06619,"busStopName":"11"}, // bus 11
            {"latitude":-36.81456,"longitude":175.08249,"busStopName":"12"}, // bus 12
            {"latitude":-36.79601,"longitude":175.04829,"busStopName":"13"}, // bus 13
            {"latitude":-36.79689,"longitude":175.03242,"busStopName":"14"}, // bus 14
    ...
    """.trimIndent()
        ...
        [
            ...
            {"latitude":-36.855171,"longitude":174.767030,"busStopName":"3"},   // bus 3
    ...
    """.trimIndent()
        ...
        for (i in 0 until jsonArray.length()) {
            ...
            val latitude = item.getDouble("latitude")
            val longitude = item.getDouble("longitude")
            val busStopName = item.getString("busStopName")
            busStops.add(BusStopInfo(latitude, longitude, busStopName))
        }
    ...
    /**
     * Retrieves predefined bus route data in JSON format.
     * This function returns a `JSONArray` representing a hardcoded set of bus routes,
     * including starting points, destinations, and route coordinates.
     *
     * @return A `JSONArray` containing bus route data.
     */
    fun getBusRoutesOffline(): JSONArray {
        val jsonString = """
        [
          {
            "starting_point": {
            ...
            "next_points": [
              {
                ...
                "route_coordinates": [
                  [174.764652, -36.854638],
                  [174.764628, -36.854597],
                  [174.764499, -36.854379],
                  [174.764492, -36.85433],
                  [174.764523, -36.854282],
                  [174.764596, -36.854248],
                  [174.765134, -36.854041],
                  [174.765798, -36.853806],
                  [174.766062, -36.853835]
                ]
              },
              {
                "latitude": -36.854254,
                ...
                "route_coordinates": [
                  ...
                  [174.764956, -36.855152],
                  [174.764723, -36.854757],
                  [174.764652, -36.854638]
                ]
              },
              {
              ...
              },
              {
                ...
                "route_coordinates": [
                  [174.767666, -36.8542],
                  [174.767695, -36.854016],
                  [174.767811, -36.854029],
                  [174.768128, -36.854071],
                  [174.768219, -36.854028],
                  [174.768202, -36.854104],
                  [174.768129, -36.854186],
                  [174.768003, -36.854266],
                  [174.7679, -36.854376],
                  [174.767631, -36.854684],
                  [174.767492, -36.85482],
                  [174.767033, -36.855219]
                ]
              },
              {
                "latitude": -36.854638,
                ...
                "route_coordinates": [
                  [174.767033, -36.855219],
                  [174.766985, -36.85526],
                  [174.766943, -36.855297],
                  [174.766909, -36.855327],
                  [174.766481, -36.855709],
                  [174.766397, -36.855785],
                  [174.766183, -36.855971],
                  [174.765935, -36.856192],
                  [174.765885, -36.856243],
                  [174.765723, -36.856243],
                  [174.765681, -36.856223],
                  [174.765655, -36.856181],
                  [174.765581, -36.856157],
                  [174.765528, -36.856116],
                  [174.765493, -36.856072],
